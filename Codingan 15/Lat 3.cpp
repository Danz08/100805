...
void Minimum(int Beban[N], int Rute[N]) {
    ...
    if (minBeban != M) {
        ...
        cout << "Tidak ada rute minimum..." << endl;
    }
}
...
int main() {
    ...
    cout << "================================================================" << endl;
    cout << "||                          LATIHAN 3                         ||\n";
    cout << "|| PROGRAM UNTUK MENAMPILKAN RUTE TERPENDEK DAN BEBAN MINIMUM ||" << endl;
    cout << "================================================================" << endl;
    ...
    for (asal = 1; asal <= N; asal++) {
        inisialisasi(asal, Beban);
        cout << "\nNode ke " << asal;
        
        cout << "\n==============================================================" << endl;
        
        for (tujuan = 1; tujuan <= N; tujuan++) { 

            Djikstra(input, Beban, Rute, asal - 1, tujuan);
            cout << asal << " ke simpul " << tujuan << " ";
            Minimum(Beban, Rute);
        }
        cout << "==============================================================" << endl;
    }
